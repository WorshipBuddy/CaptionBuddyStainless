/**
 * Verse counts per chapter for every book of the Bible.
 * Used to validate Bible references and resolve ambiguous spoken formats.
 * Keys are lowercase book names. "psalm" and "psalms" both map to the same data.
 */
export const VERSE_COUNTS: Record<string, number[]> = {
  ...
  'song of solomon': [17,17,11,16,12,14,14,17],
